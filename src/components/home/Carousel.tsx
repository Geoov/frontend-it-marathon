...
function Item(props: any) {
  return (
    <div className="slider-container" style={{ backgroundColor: `${props.item.backgroundSlider}` }}>
      <div className="slider-image">
        <div
          className="image-wrapper"
          style={{ backgroundImage: `${props.item.backgroundImage}` }}
        ></div>
      </div>
